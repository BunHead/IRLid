...
const CACHE_VERSION = 'irlid-shell-v147'; // v6.3.24 Check-in QR no longer clips: bound by min(24cqi,26vh) so it fits the height-capped stage (banner+logo+QR no longer overflow).
