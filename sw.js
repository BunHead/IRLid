...
const CACHE_VERSION = 'irlid-shell-v146'; // v6.3.23 Cheap-fix batch: cross pinned beside Direction (flex pair); outcome-QR crash guarded (undefined activeMode); Settings-nav re-gated on cached-snapshot path.
