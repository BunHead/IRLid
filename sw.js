...
const CACHE_VERSION = 'irlid-shell-v136'; // v6.3.15b Fix: exclude anchor-crosshairs from runtime-stage>* position:relative override (was collapsing container to 0x0).
