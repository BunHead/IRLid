...
VALUES (
  ...
  '<api_key - MUST start with "org_" prefix; generate as: org_<random 64-char hex via openssl rand -hex 32>. The dashboard Service-account login rejects keys not starting with org_. Example: org_REPLACE_WITH_64_HEX_CHARS_DO_NOT_COMMIT_A_REAL_KEY>',
  NULL,
  NULL,
  '{}',
  unixepoch(),
