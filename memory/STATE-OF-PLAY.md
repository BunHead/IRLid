...
| Last meaningful change | v5.9.0.13.13 (12 May mid-afternoon) — Celebration animation panel rebuilt as 6-checkbox orthogonal effects (Pulse/Background/QR/Glow/Pattern/Text), big centre-screen check-in event banner, palette wrap-around to stop CSS root defaults bleeding through short palettes, simple Text effect on/off. 13 inline patches in single day. v5.9.0.14 (10-halo-variants design) retired; replaced by `HANDOVER-CelebrationTextAndIntensity.md` brief queued for Mr. Data. |
